...
_EXTERN const char* kCNKIZGDataXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
typedef NSUInteger CNKI_Z_GDataXMLNodeKind;

@interface CNKI_Z_GDataXMLNode : NSObject <NSCopying> {
@protected
...
+ (CNKI_Z_GDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface CNKI_Z_GDataXMLElement : CNKI_Z_GDataXMLNode
...
- (CNKI_Z_GDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface CNKI_Z_GDataXMLDocument : NSObject {
@protected
